...
- **Model output:** [WRF idealized supercell (real run)](models/notebooks/wrf_idealized_supercell.ipynb) · [WRF post-proc](models/notebooks/wrf_postprocessing.ipynb) · [SWAN idealized (real run)](models/notebooks/swan_idealized_fetch.ipynb) · [ROMS/CROCO](models/notebooks/roms_croco_output.ipynb) · [wave spectra](models/notebooks/wave_spectra.ipynb)
